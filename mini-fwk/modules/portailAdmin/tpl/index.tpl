...
<p>C'est ici que vous pourrez gérer le site</p>
...
{/literal}
	...
	<p class="text-right">
		<a href='?module=portailAdmin&action=ajouter' class='btn btn-success glyphicon glyphicon-plus'> Créer un événement</a>
	</p>
